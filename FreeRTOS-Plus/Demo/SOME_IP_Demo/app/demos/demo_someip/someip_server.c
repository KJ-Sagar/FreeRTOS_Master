...
static void someip_server_task( void * arg )
{
    ...
    xBindAddress.sin_address.ulIP_IPv4 = 0; /* ANY */
    ...
    /*-----------------------------------------------------------*/
    /* Make recv() blocking (finite timeout)                     */
    /*-----------------------------------------------------------*/
    {
        TickType_t xRecvTimeout = pdMS_TO_TICKS( 30000 );
    ...
    for( ;; )
    {
        ...
        int32_t temperature = FreeRTOS_htonl( 250 );
